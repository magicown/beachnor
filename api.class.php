<?
//라이브러리
include dirname(__FILE__)."/phonlib/gabia_xmlrpccommon.php";
include dirname(__FILE__)."/phonlib/xml_helper.php";
...
DOC_XML;
	...
	public function multi_lms_send($phone, $callback, $title="", $msg, $refkey="", $reserve = "0")
	{
		if(!is_array($phone)){
			$this->m_szResultCode = "NOT ARRAY";
			$this->m_szResult = "NOT ARRAY";
