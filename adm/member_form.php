...
<div class="tbl_frm01 tbl_wrap">
    ...
    <tr>
        <th scope="row"><label for="mb_name">성명</label></th>
     ...
     <tr>
        ...
        <th scope="row"><label for="mb_tel">업체전화</label></th>
    ...
    <tr class="lev8">
        ...
        <th scope="row"><label for="mb_hp">담당자휴대폰</label></th>
        <td colspan="3"><input type="text" name="mb_hp" value="<?php echo $mb['mb_hp'] ?>" id="mb_hp" class="frm_input" size="20" maxlength="20"></td>        
    </tr>
