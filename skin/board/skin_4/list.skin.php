...
<div id="bo_list" style="width:<?php echo $width; ?>">
    ...
    <div class="bo_fx">
      ...
      <form name="fsearch" method="get">
        ...
        <select name="s_content" >
            ...
            <option value="M" <?=$s_content=='M'?' selected="selected"':''?>>남</option>
            <option value="F" <?=$s_content=='F'?' selected="selected"':''?>>여</option>
        </select>
        ...
        지역:
        <input type="text" name="s_homepage" value="<?=$s_homepage?>" size="15">
        
        업무:
        <input type="text" name="s_2" value="<?=$s_2?>" size="15">
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>">
            ...
            <td><?php echo $list[$i]['wr_1'] ?></td>
             ...
             <td><?php echo $list[$i]['wr_homepage'] ?></td>
    ...
    <div class="bo_fx">
        ...
        <ul class="btn_bo_user">
            <?php if ($write_href) { ?><li><a href="/dex_a_4.php?sca=<?=$sca.$search_lk?>" class="btn_b03">엑셀다운</a></li><?php } ?>
