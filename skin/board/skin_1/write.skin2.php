...
<section id="bo_w">
     ...
     <?php /*?> 
       ...
       <?php */?>
        ...
        <tr>
            ...
            <input type="radio" name="wr_content" value="<?=$content?>" id="nan" <? if($content=="남"){?> checked <? }?> > 남
            
            <input type="radio" name="wr_content" value="<?=$content?>" id="nv" <? if($content=="여"){?> checked <? }?> > 여
       ...
       <table>
        ...
        <tr>
            ...
            <td>
                <input type="text" name="wr_4" class="frm_input"  value="<?=$write['wr_4']?>" size="16" maxlength="50"> <input type="text" id="wr_13" name="wr_13"  value="<?php echo $write['wr_13'] ?>" class="frm_input" size="16"  > <a href="/member_ss.php?input=wr_4&input_2=wr_13" class="win_member button white small">찾기</a>
            </td>
        </tr>
  ...
  <tr>
        ...
        <tr>
            <th scope="row">담당자</th>
            <td>
               <input type="text" name="wr_14" class="frm_input" value="<?=$write['wr_14']?>">
            </td>
        </tr>
        ...
        <tr>
            ...
            <td> <input type="text" name="wr_15" class="frm_input" value="<?=$write['wr_15']?>">
            </td>
        </tr>
        ...
        <tr>
            <th scope="row">휴대폰</th>
            <td class="wr_content">
            <input type="text" name="wr_16" class="frm_input"  value="<?=$write['wr_16']?>">
            </td>
        </tr>
