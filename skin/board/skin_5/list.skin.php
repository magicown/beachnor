    ...
    <div class="bo_fx" id="bo_fx" <? if($_GET['sso']==1){?> <? }?>  style="display:block !important">
        <fieldset id="bo_sch">
            ...
            <form name="fsearch" method="get">
                ...
                거래처명:
                <input type="text" name="s_subject" class="frm_input" value="<?=$s_subject?>" size="15">
                사업자등록번호:
                <input type="text" name="s_7" class="frm_input" value="<?=$s_7?>" size="15">
                대표자명:
                <input type="text" name="s_1" class="frm_input" value="<?=$s_1?>" size="15">
                담당자명:
                <input type="text" name="s_2" class="frm_input" value="<?=$s_2?>" size="15">
