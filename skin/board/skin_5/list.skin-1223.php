...
<div id="bo_list" style="width:<?php echo $width; ?>">
    ...
    <div class="bo_fx">
      ...
      <form name="fsearch" method="get">
        ...
        입금액:
        <input type="text" name="s_4" value="<?=$s_4?>" size="15"><font color="red">원</font>
    ...
    <div class="bo_fx" style="display:block">
        ...
        <ul class="btn_bo_user">
            <?php if ($write_href) { ?><li><a href="/dex_a_5.php?sca=<?=$sca.$search_lk?>" class="button blue">엑셀다운</a></li><?php } ?>
